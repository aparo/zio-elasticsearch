...
import zio.elasticsearch.common.{ Conflicts, DefaultOperator, ExpandWildcards }
import zio.json._
...
object DeleteByQueryRequest {
  implicit val jsonDecoder: JsonDecoder[DeleteByQueryRequest] = DeriveJsonDecoder.gen[DeleteByQueryRequest]
  implicit val jsonEncoder: JsonEncoder[DeleteByQueryRequest] = DeriveJsonEncoder.gen[DeleteByQueryRequest]
}
