...
object ExistsSourceRequest {
  implicit val jsonDecoder: JsonDecoder[ExistsSourceRequest] = DeriveJsonDecoder.gen[ExistsSourceRequest]
  implicit val jsonEncoder: JsonEncoder[ExistsSourceRequest] = DeriveJsonEncoder.gen[ExistsSourceRequest]
}
