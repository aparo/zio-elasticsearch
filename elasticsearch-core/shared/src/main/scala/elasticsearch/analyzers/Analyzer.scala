...
case object Analyzer
    extends StringEnum[Analyzer]
    with StringCirceEnum[Analyzer] {
  ...
  case object ArabicLanguageAnalyzer
      extends Analyzer("arabic")
      with LanguageAnalyzer
  case object ArmenianLanguageAnalyzer
      extends Analyzer("armenian")
      with LanguageAnalyzer
  case object BasqueLanguageAnalyzer
      extends Analyzer("basque")
      with LanguageAnalyzer
  case object BrazilianLanguageAnalyzer
      extends Analyzer("brazilian")
      with LanguageAnalyzer
  case object BulgarianLanguageAnalyzer
      extends Analyzer("bulgarian")
      with LanguageAnalyzer
  case object CatalanLanguageAnalyzer
      extends Analyzer("catalan")
      with LanguageAnalyzer
  case object ChineseLanguageAnalyzer
      extends Analyzer("chinese")
      with LanguageAnalyzer
  case object CjkLanguageAnalyzer extends Analyzer("cjk") with LanguageAnalyzer
  case object CzechLanguageAnalyzer
      extends Analyzer("czech")
      with LanguageAnalyzer
  case object DanishLanguageAnalyzer
      extends Analyzer("danish")
      with LanguageAnalyzer
  case object DutchLanguageAnalyzer
      extends Analyzer("dutch")
      with LanguageAnalyzer
  case object EnglishLanguageAnalyzer
      extends Analyzer("english")
      with LanguageAnalyzer
  case object FinnishLanguageAnalyzer
      extends Analyzer("finnish")
      with LanguageAnalyzer
  case object FrenchLanguageAnalyzer
      extends Analyzer("french")
      with LanguageAnalyzer
  case object GalicianLanguageAnalyzer
      extends Analyzer("galician")
      with LanguageAnalyzer
  case object GermanLanguageAnalyzer
      extends Analyzer("german")
      with LanguageAnalyzer
  case object GreekLanguageAnalyzer
      extends Analyzer("greek")
      with LanguageAnalyzer
  case object HindiLanguageAnalyzer
      extends Analyzer("hindi")
      with LanguageAnalyzer
  case object HungarianLanguageAnalyzer
      extends Analyzer("hungarian")
      with LanguageAnalyzer
  case object IndonesianLanguageAnalyzer
      extends Analyzer("indonesian")
      with LanguageAnalyzer
  case object ItalianLanguageAnalyzer
      extends Analyzer("italian")
      with LanguageAnalyzer
  case object LatvianLanguageAnalyzer
      extends Analyzer("latvian")
      with LanguageAnalyzer
  case object NorwegianLanguageAnalyzer
      extends Analyzer("norwegian")
      with LanguageAnalyzer
  case object PersianLanguageAnalyzer
      extends Analyzer("persian")
      with LanguageAnalyzer
  case object PortugueseLanguageAnalyzer
      extends Analyzer("portuguese")
      with LanguageAnalyzer
  case object RomanianLanguageAnalyzer
      extends Analyzer("romanian")
      with LanguageAnalyzer
  case object RussianLanguageAnalyzer
      extends Analyzer("russian")
      with LanguageAnalyzer
  case object SpanishLanguageAnalyzer
      extends Analyzer("spanish")
      with LanguageAnalyzer
  case object SwedishLanguageAnalyzer
      extends Analyzer("swedish")
      with LanguageAnalyzer
  case object TurkishLanguageAnalyzer
      extends Analyzer("turkish")
      with LanguageAnalyzer
  case object ThaiLanguageAnalyzer
      extends Analyzer("thai")
      with LanguageAnalyzer
...
final case class PatternAnalyzerDefinition(
  ...
  def build(source: JsonObject): JsonObject =
    source
      .add("type", "pattern".asJson)
      .add("lowercase", lowercase.asJson)
      .add("pattern", regex.asJson)
...
final case class SnowballAnalyzerDefinition(
  ...
  def build(source: JsonObject): JsonObject =
    source
      .add("type", "snowball".asJson)
      .add("language", lang.asJson)
      .add("stopwords", stopwords.asJson)
}
