...
import zio.elasticsearch.common.Fuzziness
import zio.json._
final case class SuggestFuzziness(
  fuzziness: Option[Fuzziness] = None,
  @jsonField("min_length") minLength: Option[Int] = None,
  @jsonField("prefix_length") prefixLength: Option[Int] = None,
  transpositions: Option[Boolean] = None,
  @jsonField("unicode_aware") unicodeAware: Option[Boolean] = None
)
