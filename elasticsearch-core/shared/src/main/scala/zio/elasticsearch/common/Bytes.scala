...
object Bytes {
  ...
  case object b extends Bytes

  case object kb extends Bytes

  case object mb extends Bytes

  case object gb extends Bytes

  case object tb extends Bytes

  case object pb extends Bytes
