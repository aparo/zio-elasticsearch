...
import zio.json._
final case class SmoothingModelContainer(
  laplace: Option[LaplaceSmoothingModel] = None,
  @jsonField("linear_interpolation") linearInterpolation: Option[
    LinearInterpolationSmoothingModel
  ] = None,
  @jsonField("stupid_backoff") stupidBackoff: Option[
