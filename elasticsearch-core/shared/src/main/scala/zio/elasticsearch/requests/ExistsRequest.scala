...
object ExistsRequest {
  implicit val jsonDecoder: JsonDecoder[ExistsRequest] = DeriveJsonDecoder.gen[ExistsRequest]
  implicit val jsonEncoder: JsonEncoder[ExistsRequest] = DeriveJsonEncoder.gen[ExistsRequest]
}
