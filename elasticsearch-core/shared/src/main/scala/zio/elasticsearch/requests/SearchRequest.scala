...
final case class SearchRequest(
  ...
  @jsonField("allow_partial_search_results") allowPartialSearchResults: Boolean = true,
  @jsonField("analyze_wildcard") analyzeWildcard: Option[Boolean] = None,
  analyzer: Option[String] = None,
  @jsonField("batched_reduce_size") batchedReduceSize: Int = 512,
  ...
  @jsonField("docvalue_fields") docvalueFields: Seq[String] = Nil,
  ...
  @jsonField("max_concurrent_shard_requests") maxConcurrentShardRequests: Int = 5,
  @jsonField("pre_filter_shard_size") preFilterShardSize: Int = 128,
  ...
  @jsonField("suggest_field") suggestField: Option[String] = None,
  @jsonField("suggest_mode") suggestMode: SuggestMode = SuggestMode.missing,
  @jsonField("suggest_size") suggestSize: Option[Int] = None,
  @jsonField("suggest_text") suggestText: Option[String] = None,
  @jsonField("terminate_after") terminateAfter: Option[Long] = None,
  timeout: Option[String] = None,
  @jsonField("track_scores") trackScores: Option[Boolean] = None,
  @jsonField("track_total_hits") trackTotalHits: Option[Boolean] = None,
  ...
  def queryArgs: Map[String, String] = {
    ...
    if (batchedReduceSize != 512) queryArgs += "batched_reduce_size" -> batchedReduceSize.toString
    ...
    if (suggestMode != SuggestMode.missing) queryArgs += "suggest_mode" -> suggestMode.toString
...
object SearchRequest {
  implicit val jsonDecoder: JsonDecoder[SearchRequest] = DeriveJsonDecoder.gen[SearchRequest]
  implicit val jsonEncoder: JsonEncoder[SearchRequest] = DeriveJsonEncoder.gen[SearchRequest]
}
