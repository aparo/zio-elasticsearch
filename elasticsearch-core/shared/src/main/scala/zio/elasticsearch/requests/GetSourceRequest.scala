 ...
 */
final case class GetSourceRequest(
  index: String,
  id: String,
...
object GetSourceRequest {
  implicit val jsonDecoder: JsonDecoder[GetSourceRequest] = DeriveJsonDecoder.gen[GetSourceRequest]
  implicit val jsonEncoder: JsonEncoder[GetSourceRequest] = DeriveJsonEncoder.gen[GetSourceRequest]
}
