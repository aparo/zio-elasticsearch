...
object ReindexRequest {
  implicit val jsonDecoder: JsonDecoder[ReindexRequest] = DeriveJsonDecoder.gen[ReindexRequest]
  implicit val jsonEncoder: JsonEncoder[ReindexRequest] = DeriveJsonEncoder.gen[ReindexRequest]
}
