...
object DeleteByQueryRethrottleRequest {
  implicit val jsonDecoder: JsonDecoder[DeleteByQueryRethrottleRequest] =
    DeriveJsonDecoder.gen[DeleteByQueryRethrottleRequest]
  implicit val jsonEncoder: JsonEncoder[DeleteByQueryRethrottleRequest] =
    DeriveJsonEncoder.gen[DeleteByQueryRethrottleRequest]
}
