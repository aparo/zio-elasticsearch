...
object TermvectorsRequest {
  implicit val jsonDecoder: JsonDecoder[TermvectorsRequest] = DeriveJsonDecoder.gen[TermvectorsRequest]
  implicit val jsonEncoder: JsonEncoder[TermvectorsRequest] = DeriveJsonEncoder.gen[TermvectorsRequest]
}
