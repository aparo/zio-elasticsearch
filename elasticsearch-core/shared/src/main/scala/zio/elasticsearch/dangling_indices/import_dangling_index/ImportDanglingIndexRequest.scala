...
final case class ImportDanglingIndexRequest(
  indexUuid: String,
  errorTrace: Boolean,
  ...
  def urlPath: String = this.makeUrl("_dangling", indexUuid)

  def queryArgs: Map[String, String] = {
    // managing parameters
    val queryArgs = new mutable.HashMap[String, String]()
    acceptDataLoss.foreach { v =>
      queryArgs += ("accept_data_loss" -> v.toString)
    }
