...
//
//  def toInnerJson = {
//    var inFieldJson = JsonUtils.jsClean(
//      "query" -> query,
//      "disable_coords" -> disableCoords,
...
//
//  def toInnerJson = Json.toJson(this).asInstanceOf[Json.Obj]
//
...
//
//  def toInnerJson = {
//    val inFieldJson = JsonUtils.jsClean("points" -> points.map(_.toJson))
//    JsonUtils.jsClean(field -> inFieldJson)
//  }
//
...
//                                     @jsonField("zero_terms_query") zeroTermsQuery: Option[String] = None,
//                                     `type`: Option[String] = None,
//                                     operator: Option[String] = None,
//                                     analyzer: Option[String] = None,
//                                     boost: Double = 1.0,
...
//    nlp.foreach {
//      config =>
//        val nlpFields = Json.toJson(nlp).as[Json.Obj].fields.filter {
//          case (name, value) =>
//            name match {
//              case "id" => false
//              case "name" => false
...
//      "fuzzy_rewrite" -> fuzzyRewrite,
//      "fields" -> fields,
//      "field_boosts" -> Json.Obj(fieldBoosts.map(v => v._1 -> JsNumber(v._2)).toSeq),
//      "minimum_should_match" -> minimumShouldMatch,
//      "analyzer" -> analyzer,
...
//  }
//
//  def lt(value: String) = this.copy(includeUpper = false, to = Some(Json.Str(value)))
//
//  def lt(value: OffsetDateTime) = this.copy(includeUpper = false, to = Some(Json.Str(value.toString)))
//
//  def lt(value: Boolean) = this.copy(includeUpper = false, to = Some(Json.Bool(value)))
//
...
//
//  def lte(value: String) = this.copy(includeUpper = true, to = Some(Json.Str(value)))
//
//  def lte(value: OffsetDateTime) = this.copy(includeUpper = true, to = Some(Json.Str(value.toString)))
//
//  def lte(value: Boolean) = this.copy(includeUpper = true, to = Some(Json.Bool(value)))
//
...
//
//  def gt(value: String) = this.copy(from = Some(Json.Str(value)), includeLower = false)
//
//  def gt(value: OffsetDateTime) = this.copy(from = Some(Json.Str(value.toString)), includeLower = false)
//
//  def gt(value: Boolean) = this.copy(from = Some(Json.Bool(value)), includeLower = false)
//
...
//
//  def gte(value: String) = this.copy(from = Some(Json.Str(value)), includeLower = true)
//
//  def gte(value: OffsetDateTime) = this.copy(from = Some(Json.Str(value.toString)), includeLower = true)
//
//  def gte(value: Boolean) = this.copy(from = Some(Json.Bool(value)), includeLower = true)
//
...
//          case s: String =>
//            field = s
//            jValue.as[Json.Obj].fields.foreach{
//              case (name, jv)=>
//                name match {
...
//  ))
//
//  def lt(field: String, value: String) = new RangeQuery(field, includeUpper = false, to = Some(Json.Str(value)))
//
//  def lt(field: String, value: OffsetDateTime) = new RangeQuery(field, includeUpper = false, to = Some(Json.Str(value.toString)))
//
//  def lt(field: String, value: Boolean) = new RangeQuery(field, includeUpper = false, to = Some(Json.Bool(value)))
//
...
//
//  def lte(field: String, value: String) = new RangeQuery(field, includeUpper = true, to = Some(Json.Str(value)))
//
//  def lte(field: String, value: OffsetDateTime) = new RangeQuery(field, includeUpper = true, to = Some(Json.Str(value.toString)))
//
//  def lte(field: String, value: Boolean) = new RangeQuery(field, includeUpper = true, to = Some(Json.Bool(value)))
//
...
//
//  def gt(field: String, value: String) = new RangeQuery(field, from = Some(Json.Str(value)), includeLower = false)
//
//  def gt(field: String, value: OffsetDateTime) = new RangeQuery(field, from = Some(Json.Str(value.toString)), includeLower = false)
//
//  def gt(field: String, value: Boolean) = new RangeQuery(field, from = Some(Json.Bool(value)), includeLower = false)
//
...
//
//  def gte(field: String, value: String) = new RangeQuery(field, from = Some(Json.Str(value)), includeLower = true)
//
//  def gte(field: String, value: OffsetDateTime) = new RangeQuery(field, from = Some(Json.Str(value.toString)), includeLower = true)
//
//  def gte(field: String, value: Boolean) = new RangeQuery(field, from = Some(Json.Bool(value)), includeLower = true)
//
...
//  }
//
//  def apply(field: String, value: String) = new TermQuery(field, Json.Str(value))
//
//  def apply(field: String, value: OffsetDateTime) = new TermQuery(field, Json.Str(value.toString))
//
//  def apply(field: String, value: Boolean) = new TermQuery(field, Json.Bool(value))
//
...
//  def hasForm(implicit context: SearchContext) = context.mapping.dottedFields.nonEmpty
//
//  def default(implicit context: SearchContext) = new TermQuery(context.mapping.materializedDottedFields.head, Json.Str(""))
//
