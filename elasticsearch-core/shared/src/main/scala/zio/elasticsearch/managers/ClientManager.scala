...
trait ClientManager { this: ElasticSearchService =>
  ...
  //  def count(query: Json.Obj, indices: Seq[String] = Nil, docTypes: Seq[String] = Nil,
...
//    val realDocType = this.mappings.expandAliasType(concreteIndex(Some(index)))
  ...
  def indexDocument(index: String, id: String, document: Json.Obj)(
    implicit
    authContext: AuthContext
...
documents from a remote cluster.
   ...
   */
  def renderSearchTemplate(body: Json.Obj, id: Option[String] = None): ZioResponse[RenderSearchTemplateResponse] = {
   ...
   * @param body body the body of the call
   */
  def scriptsPainlessExecute(body: Json.Obj): ZioResponse[ScriptsPainlessExecuteResponse] = {
