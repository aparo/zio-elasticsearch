...
package zio.elasticsearch.security.clear_cached_roles
import zio._
...
final case class ClearCachedRolesRequest(
  name: String,
  ...
  def urlPath: String = this.makeUrl("_security", "role", name, "_clear_cache")
