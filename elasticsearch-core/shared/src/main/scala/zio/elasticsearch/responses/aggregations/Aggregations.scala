...
object Aggregation {
  ...
  implicit val decodeAggregation: JsonDecoder[Aggregation] =
  ...
  implicit val encodeAggregation: JsonEncoder[Aggregation] =
...
object TopHitsResult {
  implicit def decodeTopHitsResult[T](implicit encode: JsonEncoder[T], decoder: JsonDecoder[T]): JsonDecoder[TopHitsResult[T]] =
    JsonDecoder.instance { c =>
      for {
...
object Bucket {
  ...
  implicit val decodeBucket: JsonDecoder[Bucket] =
    JsonDecoder.instance { c =>
      c.keys.map(_.toList) match {
  ...
  implicit val encodeBucket: JsonEncoder[Bucket] =
    JsonEncoder.instance { obj =>
      val fields = new mutable.ListBuffer[(String, Json)]()
...
object MultiBucketBucket {
  ...
  implicit val decodeMultiBucket: JsonDecoder[MultiBucketBucket] =
    JsonDecoder.instance { c =>
      c.keys.map(_.toList) match {
        case None => Left(DecodingFailure("No fields in Bucket", Nil))
        case Some(fields) =>
  ...
  implicit val encodeMultiBucket: JsonEncoder[MultiBucketBucket] =
    JsonEncoder.instance { obj =>
      val fields = new mutable.ListBuffer[(String, Json)]()
      fields += ("doc_count" -> obj.docCount.asJson)
      obj.buckets.foreach {
...
object DocCountAggregation {
  ...
  implicit val decodeDocCountAggregation: JsonDecoder[DocCountAggregation] =
    JsonDecoder.instance { c =>
      c.keys.map(_.toList) match {
        case None =>
  ...
  implicit val encodeDocCountAggregation: JsonEncoder[DocCountAggregation] =
    JsonEncoder.instance { obj =>
      val fields = new mutable.ListBuffer[(String, Json)]()
      fields += ("doc_count" -> obj.docCount.asJson)
...
object GeoBoundsValue {
  ...
  implicit val decodeGeoBoundsValue: JsonDecoder[GeoBoundsValue] =
    JsonDecoder.instance { c =>
      c.keys.map(_.toList) match {
  ...
  implicit val encodeDocCountAggregation: JsonEncoder[GeoBoundsValue] =
    JsonEncoder.instance { obj =>
      val fields = new mutable.ListBuffer[(String, Json)]()
