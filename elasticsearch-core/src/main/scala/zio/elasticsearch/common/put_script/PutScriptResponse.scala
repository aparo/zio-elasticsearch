 ...
 */
final case class PutScriptResponse(acknowledged: Boolean = true) {}
object PutScriptResponse {
  implicit lazy val jsonCodec: JsonCodec[PutScriptResponse] =
    DeriveJsonCodec.gen[PutScriptResponse]
}
