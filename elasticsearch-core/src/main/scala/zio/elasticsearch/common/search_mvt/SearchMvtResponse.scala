 ...
 */
final case class SearchMvtResponse(
  ) {}
object SearchMvtResponse {
  implicit lazy val jsonCodec: JsonCodec[SearchMvtResponse] =
    DeriveJsonCodec.gen[SearchMvtResponse]
}
