...
final case class RankEvalRequestBody(
  ...
  metric: Option[RankEvalMetric] = None
)

object RankEvalRequestBody {
  implicit lazy val jsonCodec: JsonCodec[RankEvalRequestBody] =
    DeriveJsonCodec.gen[RankEvalRequestBody]
}
