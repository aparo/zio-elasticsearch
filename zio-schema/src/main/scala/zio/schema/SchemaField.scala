...
sealed trait SchemaFieldType[T] {
  ...
  def parse(string: String): Either[FrameworkException, T] = {
    var result: Either[FrameworkException, T] = Left(
      NoTypeParserException.default)
...
sealed trait TypedSchemaField[T] extends SchemaField {
  ...
  def parse(string: String)(implicit scriptingService: ScriptingService)
    : Either[FrameworkException, T] =
    customStringParser match {
      case Some(script) =>
        scriptingService
          .execute(script, context = Map("value" -> string))
    ...
    Encoder.AsObject.instance { obj: SchemaField =>
      val jsn = obj match {
        ...
        case o: LocalDateSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("string"))
            .add("format", Json.fromString("date"))

        case o: GeoPointSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("string"))
            .add("format", Json.fromString("geo_point"))

        case o: DoubleSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("number"))
            .add("format", Json.fromString("double"))
        case o: FloatSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("number"))
            .add("format", Json.fromString("float"))
        case o: BigIntSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("integer"))
            .add("format", Json.fromString("big"))
        case o: IntSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("integer"))
            .add("format", Json.fromString("int32"))
        case o: BooleanSchemaField =>
          o.asJsonObject.add("type", Json.fromString("boolean"))
        case o: LongSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("integer"))
            .add("format", Json.fromString("int64"))
        case o: ShortSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("integer"))
            .add("format", Json.fromString("int16"))
        case o: ByteSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("integer"))
            .add("format", Json.fromString("int8"))
        case o: ListSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("array"))
            .add("format", Json.fromString("list"))
        case o: SeqSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("array"))
            .add("format", Json.fromString("seq"))
        case o: SetSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("array"))
            .add("format", Json.fromString("set"))
        case o: VectorSchemaField =>
          o.asJsonObject
            .add("type", Json.fromString("array"))
            .add("format", Json.fromString("vector"))
...
final case class StringSchemaField(
    ...
    @JsonKey(COLUMNAR) columnProperties: ColumnProperties =
      ColumnProperties.empty,
    @JsonKey(INDEX) indexProperties: IndexingProperties =
...
object GeoPointSchemaField extends SchemaFieldType[String] {
  ...
  implicit final val encodeGeoPointSchemaField
    : Encoder.AsObject[GeoPointSchemaField] =
