...
package zio.elasticsearch.indices.promote_data_stream
import zio._
...
final case class PromoteDataStreamRequest(
  name: String,
  ...
  def urlPath: String = this.makeUrl("_data_stream", "_promote", name)
