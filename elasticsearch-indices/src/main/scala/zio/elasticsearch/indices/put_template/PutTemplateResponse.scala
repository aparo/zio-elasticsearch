 ...
 */
final case class PutTemplateResponse(acknowledged: Boolean = true) {}
object PutTemplateResponse {
  implicit lazy val jsonCodec: JsonCodec[PutTemplateResponse] =
    DeriveJsonCodec.gen[PutTemplateResponse]
}
