 ...
 */
final case class PutMappingResponse(
  ) {}
object PutMappingResponse {
  implicit lazy val jsonCodec: JsonCodec[PutMappingResponse] =
    DeriveJsonCodec.gen[PutMappingResponse]
}
