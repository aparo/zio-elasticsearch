...
//
//    val json = readResourceJSON("/zio/elasticsearch/queries/script.json")
...
//  }
  ...
  "Query" should "serialize and deserialize search" in {
    ...
    val oSearch = obj.toJson.fromJson[Search]
    obj should be(oSearch.value)

  }

  it should "serialize and deserialize BoolQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/bool_query.json")
  ...
  it should "serialize and deserialize BoostingQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/boosting_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/common_terms_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/constant_score_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize DisMaxQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/dis_max_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize ExistsQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/exists_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize FieldMaskingSpanQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/field_masking_span_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/function_score_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize FuzzyQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/fuzzy_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize GeoBoundingBoxQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/geo_bounding_box_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize GeoDistanceQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/geo_distance_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize GeoPolygonQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/geo_polygon_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize GeoShapeQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/geo_shape_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize HasChildQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/has_child_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize HasParentQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/has_parent_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize IdsQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/ids_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize MatchAllQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/match_all_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/match_none_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize MoreLikeThisQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/more_like_this_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/multi_match_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/nested_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/parent_id_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize PrefixQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/prefix_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize QueryStringQuery" in {
    val json =
      readResourceJSON("/zio/elasticsearch/queries/query_string_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize RangeQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/range_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize RegexpQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/regexp_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize ScriptQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/script_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/simple_query_string.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/span_containing_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize SpanFirstQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/span_first_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/span_multi_term_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize SpanNearQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/span_near_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize SpanNotQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/span_not_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize SpanOrQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/span_or_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize SpanTermQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/span_term_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/span_within_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
...
//  }
  ...
  it should "serialize and deserialize TermQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/term_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
    ...
    realQuery.value.as[String].toOption.get should be("Quick Foxes!")
    val nJson = oQuery.value.toJson
    nJson.fromJson[Query].value should be(realQuery)
  }

  it should "serialize and deserialize TermsQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/terms_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
  ...
  it should "serialize and deserialize WildcardQuery" in {
    val json = readResourceJSON("/zio/elasticsearch/queries/wildcard_query.json")
    val oQuery = json.as[Query]
    oQuery.isRight should be(true)
...
//    val json = readResourceJSON("/zio/elasticsearch/queries/wrapper_query.json")
//    val oQuery = json.as[Query]
//    oQuery.isRight should be(true)
