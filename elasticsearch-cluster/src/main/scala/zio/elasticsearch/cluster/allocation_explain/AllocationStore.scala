...
final case class AllocationStore(
  ...
  found: Boolean,
  @jsonField("in_sync") inSync: Boolean,
  @jsonField("matching_size_in_bytes") matchingSizeInBytes: Long,
  @jsonField("matching_sync_id") matchingSyncId: Boolean,
  @jsonField("store_exception") storeException: String
)
