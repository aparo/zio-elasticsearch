...
final case class MlInferenceIngestProcessor(
  @jsonField(
    "num_docs_processed"
  ) numDocsProcessed: MlInferenceIngestProcessorCount,
  pipelines: MlCounter,
  @jsonField("num_failures") numFailures: MlInferenceIngestProcessorCount,
  @jsonField("time_ms") timeMs: MlInferenceIngestProcessorCount
)
