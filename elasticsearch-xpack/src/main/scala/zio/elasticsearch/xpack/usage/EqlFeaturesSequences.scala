...
final case class EqlFeaturesSequences(
  ...
  @jsonField("sequence_queries_two") sequenceQueriesTwo: Int,
  @jsonField("sequence_until") sequenceUntil: Int,
  @jsonField("sequence_queries_five_or_more") sequenceQueriesFiveOrMore: Int,
  @jsonField("sequence_maxspan") sequenceMaxspan: Int
)
