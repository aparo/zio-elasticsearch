...
final case class MlDataFrameAnalyticsJobsAnalysis(
  classification: Option[Int] = None,
  @jsonField("outlier_detection") outlierDetection: Option[Int] = None,
  regression: Option[Int] = None
)
