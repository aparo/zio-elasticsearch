 ...
 */
final case class PutRoleMappingResponse(
  ) {}
object PutRoleMappingResponse {
  implicit lazy val jsonCodec: JsonCodec[PutRoleMappingResponse] =
    DeriveJsonCodec.gen[PutRoleMappingResponse]
}
