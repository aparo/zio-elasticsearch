...
package zio.elasticsearch.security.enable_user_profile
...
final case class EnableUserProfileRequest(
  uid: String,
  ...
  def urlPath: String = this.makeUrl("_security", "profile", uid, "_enable")
