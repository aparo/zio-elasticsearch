...
package zio.elasticsearch.security.saml_complete_logout
import zio._
...
final case class SamlCompleteLogoutRequest(
  body: SamlCompleteLogoutRequestBody,
  errorTrace: Boolean = false,
  filterPath: Chunk[String] = Chunk.empty[String],
  human: Boolean = false,
  pretty: Boolean = false
) extends ActionRequest[SamlCompleteLogoutRequestBody]
    with RequestBase {
  def method: Method = Method.POST

  def urlPath = "/_security/saml/complete_logout"
