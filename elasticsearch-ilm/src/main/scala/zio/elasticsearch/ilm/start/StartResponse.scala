...
package zio.elasticsearch.ilm.start
import zio.json._
/*
 ...
 */
final case class StartResponse(acknowledged: Boolean = true) {}
object StartResponse {
  implicit lazy val jsonCodec: JsonCodec[StartResponse] =
    DeriveJsonCodec.gen[StartResponse]
}
