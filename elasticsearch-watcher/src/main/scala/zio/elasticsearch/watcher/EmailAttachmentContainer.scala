...
final case class EmailAttachmentContainer(
  http: Option[HttpEmailAttachment] = None,
  reporting: Option[ReportingEmailAttachment] = None,
  data: Option[DataEmailAttachment] = None
)
