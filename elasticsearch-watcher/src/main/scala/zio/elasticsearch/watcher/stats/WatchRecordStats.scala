...
final case class WatchRecordStats(
  ...
  @jsonField("executed_actions") executedActions: Option[Chunk[String]] = None,
  @jsonField("watch_id") watchId: String,
  @jsonField("watch_record_id") watchRecordId: String,
  @jsonField("execution_time") executionTime: LocalDateTime
)

object WatchRecordStats {
  implicit lazy val jsonCodec: JsonCodec[WatchRecordStats] =
    DeriveJsonCodec.gen[WatchRecordStats]
}
