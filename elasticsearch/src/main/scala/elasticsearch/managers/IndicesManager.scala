...
class IndicesManager(client: ElasticSearch) {
  ...
  def analyze(request: IndicesAnalyzeRequest): ZioResponse[IndicesAnalyzeResponse] = client.execute(request)
  ...
  def clone(request: IndicesCloneRequest): ZioResponse[IndicesCloneResponse] = client.execute(request)
  ...
  def close(request: IndicesCloseRequest): ZioResponse[IndicesCloseResponse] = client.execute(request)
  ...
  def create(request: IndicesCreateRequest): ZioResponse[IndicesCreateResponse] = client.execute(request)
  ...
  def delete(request: IndicesDeleteRequest): ZioResponse[IndicesDeleteResponse] = client.execute(request)
  ...
  def exists(request: IndicesExistsRequest): ZioResponse[IndicesExistsResponse] = client.execute(request)
  ...
  def getAlias(request: IndicesGetAliasRequest): ZioResponse[IndicesGetAliasResponse] = client.execute(request)
  ...
  def open(request: IndicesOpenRequest): ZioResponse[IndicesOpenResponse] = client.execute(request)
  ...
  def refresh(request: IndicesRefreshRequest): ZioResponse[IndicesRefreshResponse] = client.execute(request)
...
is considered to be too large or too old.
  ...
  def segments(request: IndicesSegmentsRequest): ZioResponse[IndicesSegmentsResponse] = client.execute(request)
  ...
  def shrink(request: IndicesShrinkRequest): ZioResponse[IndicesShrinkResponse] = client.execute(request)
  ...
  def split(request: IndicesSplitRequest): ZioResponse[IndicesSplitResponse] = client.execute(request)
  ...
  def stats(request: IndicesStatsRequest): ZioResponse[IndicesStatsResponse] = client.execute(request)
  ...
  def upgrade(request: IndicesUpgradeRequest): ZioResponse[IndicesUpgradeResponse] = client.execute(request)
