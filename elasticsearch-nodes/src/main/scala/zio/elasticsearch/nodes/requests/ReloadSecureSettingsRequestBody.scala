...
package zio.elasticsearch.nodes.requests
import zio.json._
import zio.json.ast._

final case class ReloadSecureSettingsRequestBody(
  @jsonField("secure_settings_password") secureSettingsPassword: Option[
    Json
  ] = None
)
