...
final case class Breaker(
  ...
  @jsonField("limit_size") limitSize: Option[String] = None,
  @jsonField("limit_size_in_bytes") limitSizeInBytes: Option[Long] = None,
  overhead: Option[Float] = None,
  tripped: Option[Float] = None
)
