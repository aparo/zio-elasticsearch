...
final case class CertificateInformation(
  alias: Option[String] = None,
  expiry: LocalDateTime,
  format: String,
  @jsonField("has_private_key") hasPrivateKey: Boolean,
  issuer: Option[String] = None,
  path: String,
  @jsonField("serial_number") serialNumber: String,
  @jsonField("subject_dn") subjectDn: String
)
