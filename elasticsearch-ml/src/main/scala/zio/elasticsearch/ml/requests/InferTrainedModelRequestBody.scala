...
import zio._
import zio.elasticsearch.ml.InferenceConfigUpdateContainer
import zio.json._
import zio.json.ast._

final case class InferTrainedModelRequestBody(
  docs: Chunk[Map[String, Json]],
  @jsonField("inference_config") inferenceConfig: Option[
