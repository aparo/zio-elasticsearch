...
final case class PutDatafeedRequestBody(
...
object PutDatafeedRequestBody {
  implicit lazy val jsonCodec: JsonCodec[PutDatafeedRequestBody] =
    DeriveJsonCodec.gen[PutDatafeedRequestBody]
}
