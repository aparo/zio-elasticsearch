...
final case class TrainedModelDeploymentAllocationStatus(
  @jsonField("allocation_count") allocationCount: Int,
  state: DeploymentAllocationState,
  @jsonField("target_allocation_count") targetAllocationCount: Int
)
