 ...
 */
final case class ResetJobResponse(acknowledged: Boolean = true) {}
object ResetJobResponse {
  implicit lazy val jsonCodec: JsonCodec[ResetJobResponse] =
    DeriveJsonCodec.gen[ResetJobResponse]
}
