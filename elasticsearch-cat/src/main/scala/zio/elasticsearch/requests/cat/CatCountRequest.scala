...
object CatCountRequest {
  implicit val jsonDecoder: JsonDecoder[CatCountRequest] = DeriveJsonDecoder.gen[CatCountRequest]
  implicit val jsonEncoder: JsonEncoder[CatCountRequest] = DeriveJsonEncoder.gen[CatCountRequest]
}
