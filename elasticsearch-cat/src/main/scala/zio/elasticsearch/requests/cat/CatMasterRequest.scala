 ...
 */
final case class CatMasterRequest(
...
object CatMasterRequest {
  implicit val jsonDecoder: JsonDecoder[CatMasterRequest] = DeriveJsonDecoder.gen[CatMasterRequest]
  implicit val jsonEncoder: JsonEncoder[CatMasterRequest] = DeriveJsonEncoder.gen[CatMasterRequest]
}
