...
object CatAliasesRequest {
  implicit val jsonDecoder: JsonDecoder[CatAliasesRequest] = DeriveJsonDecoder.gen[CatAliasesRequest]
  implicit val jsonEncoder: JsonEncoder[CatAliasesRequest] = DeriveJsonEncoder.gen[CatAliasesRequest]
}
