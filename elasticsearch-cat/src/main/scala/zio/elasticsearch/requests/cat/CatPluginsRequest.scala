 ...
 */
final case class CatPluginsRequest(
...
object CatPluginsRequest {
  implicit val jsonDecoder: JsonDecoder[CatPluginsRequest] = DeriveJsonDecoder.gen[CatPluginsRequest]
  implicit val jsonEncoder: JsonEncoder[CatPluginsRequest] = DeriveJsonEncoder.gen[CatPluginsRequest]
}
