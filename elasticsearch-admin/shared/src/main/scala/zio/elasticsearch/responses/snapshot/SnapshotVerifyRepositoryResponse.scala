...
object SnapshotVerifyRepositoryResponse {
  implicit val jsonDecoder: JsonDecoder[SnapshotVerifyRepositoryResponse] =
    DeriveJsonDecoder.gen[SnapshotVerifyRepositoryResponse]
  implicit val jsonEncoder: JsonEncoder[SnapshotVerifyRepositoryResponse] =
    DeriveJsonEncoder.gen[SnapshotVerifyRepositoryResponse]
}
