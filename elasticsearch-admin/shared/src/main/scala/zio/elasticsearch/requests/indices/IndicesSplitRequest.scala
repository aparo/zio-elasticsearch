...
object IndicesSplitRequest {
  implicit val jsonDecoder: JsonDecoder[IndicesSplitRequest] = DeriveJsonDecoder.gen[IndicesSplitRequest]
  implicit val jsonEncoder: JsonEncoder[IndicesSplitRequest] = DeriveJsonEncoder.gen[IndicesSplitRequest]
}
