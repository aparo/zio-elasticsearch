...
object IndicesUpdateAliasesRequest {
  implicit val jsonDecoder: JsonDecoder[IndicesUpdateAliasesRequest] =
    DeriveJsonDecoder.gen[IndicesUpdateAliasesRequest]
  implicit val jsonEncoder: JsonEncoder[IndicesUpdateAliasesRequest] =
    DeriveJsonEncoder.gen[IndicesUpdateAliasesRequest]
}
