...
final case class ClusterShards(
    shards: Map[String, List[ClusterShard]] =
      Map.empty[String, List[ClusterShard]]
)
...
@JsonCodec
final case class ClusterIndexSetting(index: IndexSettings,
...
final case class Metadata(
  ...
  def getType(
      index: String): Either[IndexNotFoundException, RootDocumentMapping] =
...
final case class Blocks(
    indices: Map[String, Map[String, BlockStatus]] =
      Map.empty[String, Map[String, BlockStatus]]
)
