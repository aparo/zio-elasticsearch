...
final case class Merges(
    ...
    @JsonKey("total_stopped_time_in_millis") totalStoppedTimeInMillis: Double =
      0,
    @JsonKey("total_throttled_time_in_millis") totalThrottledTimeInMillis: Double =
      0,
    @JsonKey("total_auto_throttle_in_bytes") totalAutoThrottleInBytes: Double =
      0
)
...
final case class Segments(
    ...
    @JsonKey("stored_fields_memory_in_bytes") storedFieldsMemoryInBytes: Double =
      0,
    @JsonKey("term_vectors_memory_in_bytes") termVectorsMemoryInBytes: Double =
      0,
    ...
    @JsonKey("index_writer_memory_in_bytes") indexWriterMemoryInBytes: Double =
      0,
    @JsonKey("index_writer_max_memory_in_bytes") indexWriterMaxMemoryInBytes: Double =
      0,
    @JsonKey("version_map_memory_in_bytes") versionMapMemoryInBytes: Double = 0,
    @JsonKey("fixed_bit_set_memory_in_bytes") fixedBitSetMemoryInBytes: Double =
      0
)
