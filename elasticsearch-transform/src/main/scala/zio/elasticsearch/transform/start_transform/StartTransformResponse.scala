 ...
 */
final case class StartTransformResponse(acknowledged: Boolean = true) {}
object StartTransformResponse {
  implicit lazy val jsonCodec: JsonCodec[StartTransformResponse] =
    DeriveJsonCodec.gen[StartTransformResponse]
}
