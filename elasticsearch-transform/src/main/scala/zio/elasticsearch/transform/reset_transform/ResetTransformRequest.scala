...
package zio.elasticsearch.transform.reset_transform
...
final case class ResetTransformRequest(
  transformId: String,
  ...
  def urlPath: String = this.makeUrl("_transform", transformId, "_reset")
