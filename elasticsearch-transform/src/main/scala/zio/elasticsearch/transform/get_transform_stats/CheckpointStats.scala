...
final case class CheckpointStats(
  ...
  @jsonField("timestamp_millis") timestampMillis: Option[Long] = None,
  @jsonField("time_upper_bound") timeUpperBound: Option[LocalDateTime] = None,
  @jsonField("time_upper_bound_millis") timeUpperBoundMillis: Option[Long] = None
)
