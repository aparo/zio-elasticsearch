 ...
 */
final case class StopTransformResponse(acknowledged: Boolean = true) {}
object StopTransformResponse {
  implicit lazy val jsonCodec: JsonCodec[StopTransformResponse] =
    DeriveJsonCodec.gen[StopTransformResponse]
}
